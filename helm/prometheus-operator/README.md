...
# THIS WAS MODIFIED FROM UPSTREAM

WHY?
Needed to add extraPaths to prometheus and alertmanager ingress objects to
work with the ssl-redirect rule needed for aws-alb-ingress-controller
